...
HD_PWD='C:/Projects/04-23-test/project_3/project_3.runs/design_1_address_counter_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_address_counter_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_address_counter_1_0.tcl
