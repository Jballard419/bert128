...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/SharedProjects/04-23-test/project_3/project_3.cache/wt [current_project]
  set_property parent.project_path C:/SharedProjects/04-23-test/project_3/project_3.xpr [current_project]
  set_property ip_output_repo C:/SharedProjects/04-23-test/project_3/project_3.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet C:/SharedProjects/04-23-test/project_3/project_3.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/SharedProjects/04-23-test/project_3/project_3.srcs/sources_1/bd/design_1/design_1.bd
  set_param project.isImplRun false
  read_xdc C:/SharedProjects/04-23-test/project_3/project_3.srcs/constrs_1/new/constraints.xdc
  set_param project.isImplRun true
